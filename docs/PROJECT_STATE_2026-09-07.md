...
- Char kway teow uses **certified halal chicken lap cheong / la chang**. Authentic Chinese-sausage character is required; a generic chicken frankfurter is not an acceptable substitute.
- Use Malaysian Muslim culinary precedent first instead of reinventing halal versions of established dishes.
...
- Consumer price architecture is intentionally aggressive:
  ...
  - Char Kway Teow: **$14.95**
  - Roti: **$3.95**
  - Roti + Padang dip: **$5.25**
- Office/corporate drops, catering, preorders and direct ordering are primary economic lanes. Marketplace apps are discovery/overflow, not the foundation.
...
## Culinary/operational breakthroughs preserved

1. Four flavor lanes remain distinct: Padang curry, house sambal, dedicated Mamak-style mee goreng sauce, protected CKT.
2. Shared prep remains: one chicken prep, shared yellow noodles where appropriate, separate fresh flat rice noodles for CKT, shared potato prep and one firm tofu SKU.
...
- Corporate constrained-menu productivity: **>=24 / total paid kitchen hour**.
- Corporate drop preference: **20+ meals / destination**.
- Large office orders may be encouraged toward **2-3 main choices** to create true batching savings.
- Food waste base target: **~5% or better after stabilization**.
- Consumer packaging base target: **~$1.15/main**.
- Corporate packaging base target: **~$0.65/meal**.
- Avoid designing around 25-30% marketplace commissions.
...
- Favor a small cross-trained crew over excess headcount.
